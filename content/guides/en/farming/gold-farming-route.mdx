...
1. Put each hero on a stage they clear reliably, not the newest risky unlock.
2. Check that gear is not obviously behind, especially main weapon and defensive slots.
3. When you return, process gold, XP, and mail before deciding whether the stage should change.
